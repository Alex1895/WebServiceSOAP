 ...
 * 
 */
@WebServiceClient(name = "calculatorService", targetNamespace = "http://soap.service.hcl.com/", wsdlLocation = "http://localhost:8039/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://soap.service.hcl.com/", "calculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8039/calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://soap.service.hcl.com/", "calculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.service.hcl.com/", "calculatorPort"), Calculator.class, features);
    }
